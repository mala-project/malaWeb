            ...
            dbc.Collapse(
                dbc.Card(dbc.CardBody(
                    dcc.RangeSlider(  # TODO: allow direct keyboard input
                        ...
                        updatemode='drag', vertical=True, verticalHeight=800, pushable=x_axis[1]), style={'padding': '7px'})),
                id="x-collapse",
                is_open=False),
        ], style={'width': '2em'}),
        dbc.Card([
...
def update_scatter(slider_range, slider_range_cs_x, slider_range_cs_y, slider_range_cs_z,
                   size_slider, opacity_slider, outline, cam_pos, fig):
    dfu = scatter_df.copy()
    # print(fig["layout"])
    ...
    # x-Cross-section
    if slider_range_cs_x is not None:  # Any slider Input there?
        ...
        dfu = dfu[mask]
    # Y-Cross-section
    if slider_range_cs_y is not None:  # Any slider Input there?
        ...
        dfu = dfu[mask]
    # Z-Cross-section
    if slider_range_cs_z is not None:  # Any slider Input there?
